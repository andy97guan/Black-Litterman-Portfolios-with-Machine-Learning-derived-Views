...
ylabel('weights');
title('Max Reward to VaR portfolio weights for \delta=0.01 (Near Kelly Investor)');
...
xlabel('Out of sample period');
ylabel('weights');
title('Max Reward to VaR portfolio weights for \delta=2.24 (Average Investor) ');
legend('EFA','EEM','GLD','TLT','IYR','Location','bestoutside');
...
xlabel('Out of sample period');
ylabel('weights');
title('Max Reward to VaR portfolio weights for \delta=6 (Risk Averse Investor) ');
legend('EFA','EEM','GLD','TLT','IYR','Location','bestoutside');
set(gcf, 'Color', 'w');
print(fig,'VaR_weights.eps','-depsc2')
