...
xtrain=X1_iyr(1:split,:);
xtest=X1_iyr(split+1:end,:);

ytrain=Y1_iyr(1:split,1);
ytest=Y1_iyr(split+1:end,1);
...
title('ROC Curves for predicting sign of next weeks IYR excess return')
axis tight;
set(gcf, 'Color', 'w');
print(fig,'iyr_c1_train.eps','-depsc2')
hold off

confusion_c1_iyr=[confusion1;confusion2;confusion3;confusion4;confusion5;confusion6];
save('confusion_c1_iyr.mat','confusion_c1_iyr');
