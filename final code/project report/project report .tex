...
\bibitem{1}{P.Zhuang,F.Liu. Implicit Difference Approximation for the Time Fractional Diffusion Equation.[J] Applied Math.\&Computation Vol.22(2006),No.3,pp.87-99}
\bibitem{2} {Yuxin Zhang,Qian Li,Hengfei Ding.High-order Numerical Approximation Formulas for Riemann-Liouville(Riesz) Tempered Fractional Derivatives: Construction and Application[J] Applied Math.\&Computation 329(2018)432-443}
\bibitem{3} {P.Zhuang,F.Liu, V.Anh.New Solution and Analytical Techniques of the Implicit Numerical Method for the Anomalous Subdiffusion Equation.[J]SIAM J. Numer. Anal. Vol.46,No.2,pp.1079-1095}
\bibitem{4} {孙志忠，高广花，分数阶微分方程的有限差分办法.[M].科学出版社.2015.8}
\bibitem{5} {Minghua Chen,Weihua Deng.A Second-order Accurate Numerical Method for the Space-time Tempered Fractional Diffusion-wave Equation.[J].Applied Math.\&Computation 68(2017)87-93}
\bibitem{6} {H.Zhang,F.Liu,I.Turner,S.Chen.The Numerical Simulation of the Tempered Fractional Black-Scholes Equation for European Double Barrier Option.[J].Applied Math.\&Computation 40(2016)5819-5834}
